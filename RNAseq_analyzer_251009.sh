...
#
# DESCRIPTION:
# This is a very basic RNA-seq pipeline.
...
#
# USAGE:
# $ bash RNAseq_analyzer_251009.sh <metadata.txt> <number of threads> 
# OR use with the execute script:
# bash RNAseq_analyzer_251009.sh ../01_input/metadata.txt  $SLURM_NTASKS
#
# OUTPUT:
# Aligning reads from my genewiz sequencing experiment (AJ6 cells infected with an MOI of 3 or wt WNV, sfRNA1 mut WNV, sfRNA1&2 mut WNV,
...
inputdir="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/01_input"

#Metadata file. This pulls the metadata path and file from the command line
metadata=$1

#This is where the ht2 files live:
hisat2path="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/artibeus_genome/ajgene"

#This is where the genome sequence lives:
genomefa="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/artibeus_genome"

#This is where the gtf file lives:
gtffile="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/artibeus_genome"
...
echo "samples1 array: ${samples1[@]}"
echo "samples2 array: ${samples2[@]}"
...
cmd4="featureCounts -p -t exon -T $pthread -a $gtffile -o ${outfeature}counts.txt ${samfilePath[*]}"
echo -e "\t$ $cmd4"
time eval $cmd4
