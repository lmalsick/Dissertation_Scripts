...
output_dir <- "GSEA_Publication_Figures"
gsea_classic_dir <- file.path(output_dir, "GSEA_Classic_Plots")
cnet_dir <- file.path(output_dir, "Gene_Concept_Networks")
...
rnaGSEA = function(rnaFile, orgData, rankMetric = "pval", goCat = "All", 
