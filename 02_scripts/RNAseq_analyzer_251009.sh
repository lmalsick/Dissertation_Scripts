...
hisat2path="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/index/ajgene"

#This is where the genome sequence lives:
genomefa="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/02_scripts/GCF_021234435.1_CSHL_Jam_final_genomic.fna"

#This is where the gtf file lives:
gtffile="/scratch/alpine/lmalsick@colostate.edu/Genewiz_sequencing/02_scripts/Fixed_AJ6file.gtf"
